...
class TicTacToeManagerApplication(Application):
    def __init__(self, name='unknown'):
        ...
        self.CommandMap["startpyglet"] = self.StartPyglet
    ...
    def StartPyglet(self):
        log.info("_________Starty Pyglet app")
        from lesson05 import main
        # should be started in a seperate as another application (in seperate thread)
        main()
