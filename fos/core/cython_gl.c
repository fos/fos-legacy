/* Generated by Cython 0.13 on Tue Mar  8 11:45:53 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__fos__core__cython_gl
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from fos.core.cython_gl */

static CYTHON_INLINE float *__pyx_f_3fos_4core_9cython_gl_asfp(PyArrayObject *); /*proto*/
static CYTHON_INLINE double *__pyx_f_3fos_4core_9cython_gl_asdp(PyArrayObject *); /*proto*/
static long __pyx_f_3fos_4core_9cython_gl_offset(long *, long *, int, int); /*proto*/
static void *__pyx_f_3fos_4core_9cython_gl_taskcode(void *); /*proto*/
static int __pyx_f_3fos_4core_9cython_gl_test_thread(void); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_long = { "long", NULL, sizeof(long), 'I' };
#define __Pyx_MODULE_NAME "fos.core.cython_gl"
int __pyx_module_is_main_fos__core__cython_gl = 0;

/* Implementation of fos.core.cython_gl */
...
static char __pyx_k_7[] = " Track propagation performance functions\n";
static char __pyx_k_8[] = "ndarray_offset (line 80)";
...
/* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":49
 * 
 * #numpy pointers
...
static CYTHON_INLINE float *__pyx_f_3fos_4core_9cython_gl_asfp(PyArrayObject *__pyx_v_pt) {
  float *__pyx_r;
  __Pyx_RefNannySetupContext("asfp");

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":50
 * #numpy pointers
 * cdef inline float* asfp(cnp.ndarray pt):
 *     return <float *>pt.data             # <<<<<<<<<<<<<<
 * 
...
/* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":52
 *     return <float *>pt.data
 * 
 * cdef inline double* asdp(cnp.ndarray pt):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE double *__pyx_f_3fos_4core_9cython_gl_asdp(PyArrayObject *__pyx_v_pt) {
  double *__pyx_r;
  __Pyx_RefNannySetupContext("asdp");

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":53
 * 
 * cdef inline double* asdp(cnp.ndarray pt):
 *     return <double *>pt.data             # <<<<<<<<<<<<<<
 * 
...
/* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":55
 *     return <double *>pt.data
 * 
 * cdef  long offset(long *indices,long *strides,int lenind, int typesize) nogil:             # <<<<<<<<<<<<<<
 * 
...
static  long __pyx_f_3fos_4core_9cython_gl_offset(long *__pyx_v_indices, long *__pyx_v_strides, int __pyx_v_lenind, int __pyx_v_typesize) {
  int __pyx_v_i;
  long __pyx_v_summ;
  long __pyx_r;
  int __pyx_t_1;

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":73
 * 
 *     cdef int i
 *     cdef long summ=0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":74
 *     cdef int i
 *     cdef long summ=0
 *     for i from 0<=i<lenind:             # <<<<<<<<<<<<<<
 *         #print('st',strides[i],indices[i])
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {
    ...
    /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":76
 *     for i from 0<=i<lenind:
 *         #print('st',strides[i],indices[i])
 *         summ+=strides[i]*indices[i]             # <<<<<<<<<<<<<<
 *     summ/=<long>typesize
 *     return summ
 */
    __pyx_v_summ += ((__pyx_v_strides[__pyx_v_i]) * (__pyx_v_indices[__pyx_v_i]));
  }

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":77
 *         #print('st',strides[i],indices[i])
 *         summ+=strides[i]*indices[i]
 *     summ/=<long>typesize             # <<<<<<<<<<<<<<
 *     return summ
 * 
 */
  __pyx_v_summ /= ((long)__pyx_v_typesize);

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":78
 *         summ+=strides[i]*indices[i]
 *     summ/=<long>typesize
 *     return summ             # <<<<<<<<<<<<<<
 * 
...
/* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":80
 *     return summ
 * 
 * def ndarray_offset(cnp.ndarray[long, ndim=1] indices, \             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_3fos_4core_9cython_gl_ndarray_offset(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("ndarray_offset");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      case  1:
      values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__strides);
      if (likely(values[1])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("ndarray_offset", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__lenind);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("ndarray_offset", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__typesize);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("ndarray_offset", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "ndarray_offset") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_indices = ((PyArrayObject *)values[0]);
    __pyx_v_strides = ((PyArrayObject *)values[1]);
    __pyx_v_lenind = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_lenind == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_typesize = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_typesize == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
    goto __pyx_L5_argtuple_error;
  } else {
    __pyx_v_indices = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 0));
    __pyx_v_strides = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 1));
    __pyx_v_lenind = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_lenind == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_typesize = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely((__pyx_v_typesize == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("ndarray_offset", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("fos.core.cython_gl.ndarray_offset");
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_bstruct_indices.buf = NULL;
  __pyx_bstruct_strides.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_indices), __pyx_ptype_5numpy_ndarray, 1, "indices", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_strides), __pyx_ptype_5numpy_ndarray, 1, "strides", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_indices, (PyObject*)__pyx_v_indices, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_indices = __pyx_bstruct_indices.strides[0];
  __pyx_bshape_0_indices = __pyx_bstruct_indices.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_strides, (PyObject*)__pyx_v_strides, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_strides = __pyx_bstruct_strides.strides[0];
  __pyx_bshape_0_strides = __pyx_bstruct_strides.shape[0];

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":111
 *     '''
 * 
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_f_3fos_4core_9cython_gl_offset(((long *)__pyx_v_indices->data), ((long *)__pyx_v_strides->data), __pyx_v_lenind, __pyx_v_typesize)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":113
 *     return offset(<long*>indices.data,<long*>strides.data,lenind, typesize)
 * 
 * cdef void *taskcode(void *argument):             # <<<<<<<<<<<<<<
 * 
...
static  void *__pyx_f_3fos_4core_9cython_gl_taskcode(void *__pyx_v_argument) {
  int __pyx_v_tid;
  int *__pyx_v_ptid;
  void *__pyx_r;
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("taskcode");

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":117
 *     cdef int tid
 *     cdef int *ptid
 *     ptid = <int *> argument             # <<<<<<<<<<<<<<
 *     tid = ptid[0]
 ...
 */
  __pyx_v_ptid = ((int *)__pyx_v_argument);

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":118
 *     cdef int *ptid
 *     ptid = <int *> argument
 *     tid = ptid[0]             # <<<<<<<<<<<<<<
 *     #printf("Hello World! It's me, thread %d!\n", tid);
 *     print(tid)
 */
  __pyx_v_tid = (__pyx_v_ptid[0]);

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":120
 *     tid = ptid[0]
 *     #printf("Hello World! It's me, thread %d!\n", tid);
 *     print(tid)             # <<<<<<<<<<<<<<
 *     return NULL
 * 
 */
  __pyx_t_1 = PyInt_FromLong(__pyx_v_tid); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 120; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PrintOne(0, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 120; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":121
 *     #printf("Hello World! It's me, thread %d!\n", tid);
 *     print(tid)
 *     return NULL             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_WriteUnraisable("fos.core.cython_gl.taskcode");
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":125
 * DEF NUM_THREADS=5
 * 
...
static  int __pyx_f_3fos_4core_9cython_gl_test_thread(void) {
  pthread_t __pyx_v_threads[5];
  int __pyx_v_thread_args[5];
  int __pyx_v_rc;
  int __pyx_v_i;
  int __pyx_r;
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("test_thread");

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":131
 *     cdef int rc, i
 * 
 ...
 */
  for (__pyx_v_i = 0; __pyx_v_i < 5; __pyx_v_i++) {
    ...
    /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":133
 *     for i from 0<=i<NUM_THREADS:
 * 
 *       thread_args[i] = i             # <<<<<<<<<<<<<<
 *       print(i)
 ...
 */
    (__pyx_v_thread_args[__pyx_v_i]) = __pyx_v_i;

    /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":134
 * 
 *       thread_args[i] = i
 *       print(i)             # <<<<<<<<<<<<<<
 *       rc = pthread_create(&threads[i], NULL, taskcode, <void *> &thread_args[i]);
 ...
 */
    ...
    /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":135
 *       thread_args[i] = i
 *       print(i)
 *       rc = pthread_create(&threads[i], NULL, taskcode, <void *> &thread_args[i]);             # <<<<<<<<<<<<<<
 * 
 *     for i from 0<=i<NUM_THREADS:
 */
    __pyx_v_rc = pthread_create((&(__pyx_v_threads[__pyx_v_i])), NULL, __pyx_f_3fos_4core_9cython_gl_taskcode, ((void *)(&(__pyx_v_thread_args[__pyx_v_i]))));
  }

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":137
 *       rc = pthread_create(&threads[i], NULL, taskcode, <void *> &thread_args[i]);
 * 
 *     for i from 0<=i<NUM_THREADS:             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_v_i = 0; __pyx_v_i < 5; __pyx_v_i++) {
    ...
    /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":138
 * 
 *     for i from 0<=i<NUM_THREADS:
 *       rc = pthread_join(threads[i], NULL)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_WriteUnraisable("fos.core.cython_gl.test_thread");
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":140
 *       rc = pthread_join(threads[i], NULL)
 * 
 * def test():             # <<<<<<<<<<<<<<
 *     test_thread()
...
static PyObject *__pyx_pf_3fos_4core_9cython_gl_test(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pf_3fos_4core_9cython_gl_test(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannySetupContext("test");
  __pyx_self = __pyx_self;

  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":141
 * 
 * def test():
 *     test_thread()             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_f_3fos_4core_9cython_gl_test_thread();
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("ndarray_offset"), (PyCFunction)__pyx_pf_3fos_4core_9cython_gl_ndarray_offset, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_3fos_4core_9cython_gl_ndarray_offset)},
  {__Pyx_NAMESTR("test"), (PyCFunction)__pyx_pf_3fos_4core_9cython_gl_test, METH_NOARGS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcython_gl(void); /*proto*/
PyMODINIT_FUNC initcython_gl(void)
#else
PyMODINIT_FUNC PyInit_cython_gl(void); /*proto*/
PyMODINIT_FUNC PyInit_cython_gl(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_cython_gl(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cython_gl"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_7), 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_fos__core__cython_gl) {
  ...
  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":10
 * cimport cython
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":46
 * 
 ...
 */
  ...
  /* "/home/sgerhard/dev/Fos/fos/core/cython_gl.pyx":1
 ...
 */
  ...
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__ndarray_offset); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init fos.core.cython_gl");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fos.core.cython_gl");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
