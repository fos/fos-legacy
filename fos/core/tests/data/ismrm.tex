...
Beacuse the datasets are so different in size and number of tracks, 
identifying corresponding tracks is a hard problem. 
...
\item {[}1{]} Lee JG, Han J, Whang KY (2007). Trajectory clustering: a partition-and-group framwork. Proc. 2007 ACM SIGMOD 
